...
class SegMoudle(nn.Module):
    def __init__(self,num_classes,embed_dim=768,freeze_backbone=False):
        super().__init__()
        ...
        self.mamba = Mamba(embed_dim, d_state=16, expand=2)
        self.mamba2 = Mamba(embed_dim*2, d_state=16, expand=2)
